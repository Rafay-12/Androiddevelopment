...
import com.example.carmanagementsystem.main.ui.viewmodel.CarViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var searchModel: Button
    ...
    private fun initUi() {
        ...
        searchModel = findViewById(R.id.searchByModel)
    ...
    private fun setListeners() {
        ...
        display.setOnClickListener {
            carViewModel.allCars.observe(this) { carList ->
